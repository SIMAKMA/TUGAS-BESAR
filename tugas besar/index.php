    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SIMAKMA</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="?page=penduduk"><i class="fa fa-table fa-3x"></i> Data Penduduk</a>
                    </li>

                    <li  >
                        <a  href="?page=tambah"><i class="fa fa-edit fa-3x"></i> Tambah Data </a>
                    </li>
